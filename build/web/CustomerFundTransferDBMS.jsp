...
<html>
    <body>
        ...
        <%
            try {
                int lastbal = 0;
                String viewquerylast = "select * from "+session.getAttribute("loginid")+";" ;
                ...
                int depamount = Integer.parseInt(request.getParameter("wthamt"));

                String depistequery = "insert into " + session.getAttribute("loginid")+" values(?,?,?,?,?,?,?);";
                ...
                pst1.executeUpdate();
                out.println("fund transfer from "+session.getAttribute("loginid")+"successfully.....");
